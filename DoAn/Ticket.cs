...
namespace DoAn
{
    public partial class Ticket : Form
    {
        ...
        private void btnDatVe_Click(object sender, EventArgs e)
        {
            ...
            string maSuat = cmbSuatchieu.SelectedItem.ToString(); 

            string gheChon = cmbGhe.SelectedItem.ToString(); 
    ...
    ";
        ...
        private void PhimDangChieu_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
