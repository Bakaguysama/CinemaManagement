        ...
        private void LoadFoodData()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    foodDataGridView.Columns["TenSanPham"].HeaderText = "Tên Sản Phẩm";
                    foodDataGridView.Columns["Gia"].HeaderText = "Giá";
                    foodDataGridView.Columns["MoTa"].HeaderText = "Mô Tả";
                    foodDataGridView.Columns["HinhAnh"].HeaderText = "Hình Ảnh";
                    foodDataGridView.Columns["DanhMuc"].HeaderText = "Danh Mục";

                    foodDataGridView.Columns["TenSanPham"].Width = 200;
                    foodDataGridView.Columns["Gia"].Width = 100;
                    foodDataGridView.Columns["MoTa"].Width = 250;
                    foodDataGridView.Columns["HinhAnh"].Width = 100;
                    foodDataGridView.Columns["DanhMuc"].Width = 150;
                }
            }
